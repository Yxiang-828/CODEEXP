  ...
  return (
    <header className="h-auto py-4 bg-surface-0 border-b border-border-strong flex items-center justify-between px-8 z-20 relative">
      <div className="flex items-center gap-2 md:gap-6">
        <select
          className="bg-surface-3 text-text-inverse text-[11px] font-bold uppercase tracking-widest px-4 py-2 rounded-none border-none outline-none cursor-pointer appearance-none min-w-[120px]"
          value={role}
        ...
        <div className="hidden md:flex items-center gap-2 px-3 py-1 border border-border-strong rounded-none shadow-[2px_2px_0px_rgba(26,26,26,1)]">
        ...
        <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-surface-2 border border-border-strong rounded-none">
          <span className="text-[10px] uppercase font-bold tracking-widest text-text-primary">Briefing (3)</span>
        </div>
        <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-surface-2 border border-border-strong rounded-none">
          <span className="text-[10px] uppercase font-bold tracking-widest text-text-secondary">Updated 1m ago</span>
        </div>
      </div>
